...
Clean base: identical to SDCNFeedbackAnimation with FloweR smoothing.
Audio-reactive features to be rebuilt from docs/AUDIO_REACTIVE_FINDINGS.md.
"""
...
def _apply_cn_per_frame(positive, negative, control_net, hint_tensor, strength):
    ...
    control_hint = hint_tensor.movedim(-1, 1)
    cnets = {}
    out_lists = []
...
class SDCNFeedbackAnimationAudio:
    ...
    Currently identical to the base node + FloweR smoothing.
    Audio-reactive features to be rebuilt — see docs/AUDIO_REACTIVE_FINDINGS.md.
    """
